...
<nav>
  <ul class="">
            ...
            <li><a class="aktif" href="fiko_fasilitas_home.php">Fasilitas</a></li>
...
<div class="box2">
  ...
  <br> 
  <img src="../fiko_fasilitas_hotel/upload/<?php echo $fiko_d['fiko_foto']?>" width="320px" height="200px">

  <h3><?php echo $fiko_d['fiko_nama_fasilitas']?></h3>
  <h4><?php echo $fiko_d['fiko_keterangan']?></h4>
